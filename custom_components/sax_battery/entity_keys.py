...
SAX_SMARTMETER_ENERGY_PRODUCED = "smartmeter_energy_produced"
SAX_SMARTMETER_ENERGY_CONSUMED = "smartmeter_energy_consumed"
SAX_SMARTMETER_SWITCHING_STATE = "smartmeter_switching_state"
