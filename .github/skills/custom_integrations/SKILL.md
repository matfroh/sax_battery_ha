---
name: Home Assistant Custom Integration knowledge
description: Everything you need to know to build, test and review Home Assistant Integrations. If you're looking at an integration, you must use this as your primary reference.
---

### File Locations

- **Integration code**: `./homeassistant/custom_components/<integration_domain>/`
- **Integration tests**: `./tests/custom_components/<integration_domain>/`
...
```
homeassistant/custom_components/my_integration/
...
- Integration structure:
  - `homeassistant/custom_components/{domain}/const.py` - Constants
  - `homeassistant/custom_components/{domain}/models.py` - Data models
  - `homeassistant/custom_components/{domain}/coordinator.py` - Update coordinator
  - `homeassistant/custom_components/{domain}/config_flow.py` - Configuration flow
  - `homeassistant/custom_components/{domain}/{platform}.py` - Platform implementations
...
- **Location**: `tests/custom_components/{domain}/`
...
- **Integration-specific tests** (recommended):
  ...
  ```bash
  pytest ./tests/custom_components/<integration_domain> \
    --cov=homeassistant.custom_components.<integration_domain> \
...
def mock_device_api() -> Generator[MagicMock]:
    ...
    with patch("homeassistant.custom_components.my_integration.MyDeviceAPI", autospec=True) as api_mock:
...
async def init_integration(
    ...
    with patch("homeassistant.custom_components.my_integration.PLATFORMS", platforms):
...
python -m script.hassfest --integration-path homeassistant/custom_components/my_integration

# Validate quality scale
# Check quality_scale.yaml against current rules

# Run integration tests with coverage
pytest ./tests/custom_components/my_integration \
  --cov=homeassistant.custom_components.my_integration \
  --cov-report term-missing
```
